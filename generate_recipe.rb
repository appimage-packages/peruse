...
appimage.frameworks = 'karchive kconfig kwidgetsaddons kcompletion kcoreaddons kauth polikit-qt5-1 kcodecs kdoctools ki18n kguiaddons kconfigwidgets kitemviews kiconthemes kjobwidgets kwindowsystem knotifications kcrash kdbusaddons kservice solid sonnet ktextwidgets attica kglobalaccel kxmlgui kbookmarks kio kpackage kfilemetadata kdeclarative baloo plasma-integration'
